		...
		<div class="container" id="startchange">
			<div class="row">
				...
				<div id="content-hello-about" class="col-lg-4">
					...
					<hr>
					<p>Nothing compares to that feeling when you get what you want.
						I am here to make it possible for you.</p>
					<hr>
					<div class="">
						<span class="glyphicon glyphicon-leaf" aria-hidden="true"></span>
						&nbsp;&nbsp; Listen <br /> <span class="glyphicon glyphicon-leaf"
							aria-hidden="true"></span> &nbsp;&nbsp; Create <br /> <span
						...
						<div class="caption">
							...
							<p>
								<a href="http://codepen.io/LubaMay/full/dMNedO/"
									class="btn btn-success btn-block" role="button" target="_blank">Look
									closer</a>
							</p>
						</div>
					</div>
					...
					<div class="section-title center">
						...
						<ul class="list-inline text-center">
							...
							<li><a href="https://github.com/LubaMay" type="button"
								class="btn btn-info" target="_blank"><i class="fa fa-github">
										GitHub</i></a></li>
