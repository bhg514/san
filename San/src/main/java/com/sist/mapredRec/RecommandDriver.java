	   ...
	   public void copyFromLocal(){
		   try{
			   ...
			   fs.copyFromLocalFile(
					   new Path("/home/stellayoon/git/san/San/src/main/webapp/data/naver/localsan.txt"), 
	   ...
	   public void copyToLocal(){
		   try{
			   ...
			   fs.copyToLocalFile(
					   ...
					   new Path("/home/stellayoon/git/san/San/src/main/webapp/data/naver/output/recommand/part-r-00000"));
			   fs.close();
